...
<html lang="en">
      ...
      <div class="breaking-news px-4">
          ...
          <?php 
           $brakingnews = $videoupload->getBrakingNewsData();
            ...
            <a style="color: white; text-decoration: none;" href="single-news.php?id=<?php echo $row['id']?>">
        ...
        <div class="col-xl-8">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <?php
               $singleData = $videoupload->getAllSingleData2();
               if($singleData){
 ...
 <div class="col-xl-4 col-sm-12" style="height :340px; overflow: auto;">
    <?php
      ...
      <video class="rounded-4" src="uploads/file/<?php echo $row['file']; ?>" width='280' type="video/mp4" loop class="clip" muted ></video>
...
<div class="row py-2">
  ...
  <!-- sidebar-2 -->
  <div class="col-xl-3">   
  <h3 class=" link text-center bg-warning p-2">LINK</h3>
   <div class="link" >
   ...
   <!--contact section -->
  <div class="container-fluid px-5">
  <div class="row bg-success text-light rounded-4 my-4">
